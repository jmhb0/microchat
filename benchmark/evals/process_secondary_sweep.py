"""
python -m ipdb benchmark/evals/process_secondary_sweep.py
by YS
"""
import pandas as pd 
import ipdb
...
cols = ['Llama-3-VILA1.5-8b_prediction', 'VILA1.5-40b_prediction',
       ...
       'VILA1.5-3b_prediction', 'Phi-3-Vision_prediction', 'idefics2_8b_prediction',
       'cogvlm2-llama3-chat-19B_prediction']
cols_pred = []
